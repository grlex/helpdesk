...
(function(window, $, easyXDM){
    ...
    var FOS_COMMENT = {
                ...
                function(e) {
                    ...
                    FOS_COMMENT.post(
                        ...
                        function(data, statusCode) {
                            FOS_COMMENT.appendComment(data, that, fos_comment_container_selector);
        ...
        appendComment: function(commentHtml, form, containerSelector) {
            var form_data = form.data();
            ...
            if('' != form_data.parent) {
                ...
                // Insert the comment
                if(containerSelector) $(containerSelector).prepend(commentHtml);
                else form.after(commentHtml);
